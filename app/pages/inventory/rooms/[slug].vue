...
const { state: roomState, asyncStatus: roomStatus } = useQueryColada(roomBySlugQuery(roomSlug.value))
...
<template>
  <main class="mx-auto max-w-6xl px-4 py-8 lg:px-8 sm:px-6">
    <PageTitle
      ...
      :description="room ? `Slug: ${room.roomId}` : 'View room details by room slug.'"
    />
    ...
    <NAlert
      ...
      description="No room exists for the provided slug."
