...
watch(mostDetectedItem, (detection) => {
  ...
  // or if it's a barcode and the string starts with 'fbt'
  if (detection.format === 'QRCode' && detection.code.length > 50 || detection.format === 'Code128' && detection.code.startsWith('fbt')) {
