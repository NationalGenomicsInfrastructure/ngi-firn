...
const formElementId = computed(() => props.formId ?? `inventory-equipment-add-${props.roomDocumentId}`)
...
const onSubmit = handleSubmit(async (values) => {
  const payload = mapEquipmentFormValuesToCreatePayload(values, props.roomDocumentId)
